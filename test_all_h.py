...
opt.test_audio_video_length = len(os.listdir(opt.test_root))-2
opt.test_A_path = './faces/align2'
...
for ado in audios:
    ...
    for i in test_names:
        ...
        model, _, start_epoch = util.load_test_checkpoint_nolip(opt.test_resume_path, model)
