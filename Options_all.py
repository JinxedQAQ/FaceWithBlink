...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--test_resume_path', default='/home/h2/Talkingface_BnoLip/checkpoints/406_22240000_Speech_reco_checkpoint.pth.tar',
                                 help='path to test resume models')
        self.parser.add_argument('--test_audio_video_length', type=int, default=27, help='# of files in the audio folder')
